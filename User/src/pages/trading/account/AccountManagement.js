        ...
        >
          ...
          >
            <TextField
              ...
              style={{ margin: "auto", display: "block", width: "60%", color: "white" }}
            />
            <TextField
              label="Stop Loss"
              variant="standard"
              ...
              style={{ margin: "auto", display: "block", width: "60%", color: "white" }}
            />
            <div style={{ display: "flex", margin: "15px auto", width: "60%" }}>
              <Button
                variant="outlined"
                onClick={handleUpdateSave}
                style={{ margin: "5px 10px", backgroundColor: "#171b25", color: "white" }}
              >
                Save
              </Button>
              <Button
